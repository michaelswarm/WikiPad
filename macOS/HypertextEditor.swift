...
//  TextLibraryProto
//
//  Created by Michael Swarm on 7/15/20.
//
...
struct HypertextEditor: NSViewRepresentable {
    ...
    init(text: Binding<String>, libraryState: HypertextEditorState) {
        ...
        print("HypertextEditor init...") // Called each document.
    }
    class Coordinator: NSObject, NSTextViewDelegate {
        ...
        init(text: Binding<String>, libraryState: HypertextEditorState) {
            _text = text
            self.libraryState = libraryState
            print("HyperTextsEditor Coordinator init...")
        }
        ...
        public func textViewDidChangeSelection(_ notification: Notification) {
            ...
            // selection = textView.selectedRange() // Modifying state during view update, this will cause undefined behavior. (This warning was new after changing document model from object to value type. At present @State selection is unused. (Eventually use for add document title = selection.)
        }
        public func textView(_ textView: NSTextView, clickedOnLink link: Any, at charIndex: Int) -> Bool {
            ...
            if let linkString = link as? String { // link is value of NSLinkAttributeName, which is just a string.
                ...
                _trace { "Link clicked: \(linkString)" }
                ...
                if linkString.starts(with: "http://") { // External Link
                    ...
                    // How does this update the links??? Yet it appears to do so???
                    libraryState.selection = title // Update library model selection here. Requires reference (Object, Binding) to model.
            ...
            _trace { "Link clicked. Can not decode: \(link)" }
    ...
    func makeNSView(context: NSViewRepresentableContext<HypertextEditor>) -> NSScrollView { // NSTextView
        print("Make NSView NSScrollView + NSTextView...") // Called 1x.
        ...
        // Must setup text storage, text container and layout manager before text view.
        /*let textStorage = MyNSTextStorage()
        
        let layoutManager = NSLayoutManager()
        // layoutManager.allowsNonContiguousLayout = true // ???
        
        let textContainer = NSTextContainer(size: CGSize(width: .max, height: .max))
        textContainer.widthTracksTextView = true
        textContainer.heightTracksTextView = true
        // textContainer.exclusionPaths = [NSBezierPath(rect: CGRect(x: 0.0, y: 0.0, width: 40.0, height: .greatestFiniteMagnitude))] // ???
        ...
        // let viewLinks = links
        // let coordinatorLinks = context.coordinator.links
        // print("View links: \(viewLinks)...")
        // print("Coordinator links: \(coordinatorLinks)")
        ...
        textView.font = bodyFontOSX // No dynamic type?
        textView.textColor = NSColor.textColor // Should be default.
        
        return scrollView
        // return textView
    }
    func updateNSView(_ nsView: NSScrollView, context: NSViewRepresentableContext<HypertextEditor>) {
        print("Update NSView NSScrollView + NSTextView...")
        ...
        // let coordinator = textView.delegate as! Coordinator
        // coordinator.links = links // Set coordinator links from wrapper links.
...
extension HypertextEditor.Coordinator: NSTextStorageDelegate {
    ...
    func textStorage(_ textStorage: NSTextStorage, didProcessEditing editedMask: NSTextStorageEditActions, range editedRange: NSRange, changeInLength delta: Int) {
        ...
        // These are to help understand how parameters reflect edits. What are edited mask and editid range???
        /*
        switch editedMask {
        ...
        */
        ...
        // textStorage.processEdit(editedRange: editedRange, keywords: ["IF", "THEN"])
        // print("TextStorage links: \(document.links), Coordinator links: \(links)") // This always has links from first document. copy of document.
        textStorage.processEdit(editedRange: editedRange, keywords: libraryState.links) // NSMutableAttributedString extension, which uses ParagraphStyle and other extensions.
    }
}
